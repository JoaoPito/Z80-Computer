...
MONSTT:  EQU     0A000H           ; Start of monitor
...
MIF:     CALL    EVAL            ; Evaluate expression
        LD      A,(HL)          ; Get token
        CP      ZGOTO           ; "GOTO" token?
...
EXPTEN: INC     B               ; Count subtractions
        ...
        ADD     A,10+"0"        ; Restore and make ASCII
        INC     HL              ; Move on
